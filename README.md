...
| Task             | Description                                                                                                                                     |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `start`          | Run `npm run start` or `yarn run start`                                                                                                                             |
| `build`          | Build bestil-app using `npm run build` or `yarn run build`                                                                                                 |
| `test`   |  Test bestil-app using `npm run test` or `yarn run test`                               |
                                   |
